document.addEventListener("DOMContentLoaded", function () {
  ...
  var traducciones = {
    e: {
      ...
      ultimasObras: '<h1>Últimas Obras<div class="separador"></h1>',
      vermas: "Ver Más",
      titulos: {
    ...
    c: {
      ...
      ultimasObras: '<h1>Últimes Obres<div class="separador"></h1>',
      vermas: "Veure Més",
      titulos: {
    ...
    a: {
      ...
      descripciones: {
        descripcion1:
          "Willkommen bei Caminer, wo Projekte Gelegenheiten sind, Ihre Visionen in die Realität umzusetzen. Mit mehr als 12 Erfahrung zeichnen wir uns durch unsere Fähigkeit aus, nicht nur Strukturen zu bauen, sondern auch langanhaltende Beziehungen mit unseren Kunden aufzubauen. Unsere Leidenschaft für Innovation und Nachhaltigkeit treibt uns dazu, die neuesten Technologien und ökologischen Materialien zu integrieren, um einen positiven Einfluss auf die Gemeinschaften und die Umwelt zu gewährleisten.",
        descripcion2:
          "Bei Caminer ist es unser Engagement, Bauleistungen höchster Qualität zu liefern. Wir sind stolz darauf, mit Präzision und Hingabe an jedem Projekt zu arbeiten, von Wohnhäusern bis hin zu kommerziellen Infrastrukturen. Wir bieten maßgeschneiderte Dienstleistungen an, die auf die einzigartigen Bedürfnisse jedes Kunden zugeschnitten sind, und stellen sicher, dass jedes Projekt rechtzeitig und innerhalb des Budgets abgeschlossen wird.",
        descripcion3:
